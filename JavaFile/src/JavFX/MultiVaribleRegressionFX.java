...
public class MultiVaribleRegressionFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button multiVariableRegression = new Button("Two Variable Regression");
        Button analyticHierarchy = new Button("Three Variable Regression");
        Button pageRankAlgorithm = new Button("Four Variable Regression");
        ...
        multiVariableRegression.setPrefSize(500, 80);
        analyticHierarchy.setPrefSize(500, 80);
        pageRankAlgorithm.setPrefSize(500, 80);
